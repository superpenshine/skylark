...
def main():
    ...
    if config.m == 'v':
        ...
        # get_frames(solver, str(config.h5_dir_win) + "_tr.h5", d_name='sigma_data', var=1)
        get_frames(solver.inter, 'D:/sigma_data/data_logpolar_tr.h5', d_name='sigma_data', var=1)
